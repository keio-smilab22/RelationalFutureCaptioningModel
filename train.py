...
def main():
    ...
    for i in range(args.start_run):
        ...
        if args.test:
            ...
            trainer.test_epoch(test_loader, datatype=args.datatype, do_knn=args.do_knn, test=args.test)
        elif args.validate:
            ...
            trainer.validate_epoch(val_loader, datatype=args.datatype, validate=args.validate)
        else:
            trainer.train_model(
